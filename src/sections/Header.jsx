  ...
  return (
    <header className='fixed top-0 left-0 z-50 w-full py-10'>
        <div className='container flex h-14 items-center max-lg:px-5'>
            ...
            <div className={clsx(`w-full max-lg:fixed max-lg:top-0 max-lg:left-0
            max-lg:w-full max-lg:bg-s2 max-lg:opacity-0`, isOpen ? 'max-lg:opacity-100' :
            'max-lg:pointer-none')}>
            ...
            max-md:px-4'>
                <nav className='max-lg:relative max-lg:z-2 max-lg:my-auto'>
                    ...
                    h-[380px] translate-x-[-290px] -trnslate-y-1/2 rotate-90'>
                        <img 
